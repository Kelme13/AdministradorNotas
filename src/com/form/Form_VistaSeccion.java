...
public class Form_VistaSeccion extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextField1.setFont(new java.awt.Font("Roboto Light", 0, 20)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(232, 19, 190));
        jTextField1.setText("Nomb_clase");

        jTextField2.setFont(new java.awt.Font("Roboto Light", 0, 20)); // NOI18N
        jTextField2.setForeground(new java.awt.Color(232, 19, 190));
        jTextField2.setText("seccion");
        ...
        jTextField3.setFont(new java.awt.Font("Roboto Light", 0, 20)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(232, 19, 190));
        jTextField3.setText("Nomb_clase");

...
public class MessageInput extends javax.swing.JDialog {
    ...
    public MessageInput(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        lbIcon.setIcon(IconFontSwing.buildIcon(GoogleMaterialDesignIcons.INPUT, 60, new Color(254, 86, 96), new Color(113, 74, 67)));
        setOpacity(0f);
